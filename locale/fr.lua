local strings = {
  ...
  SI_FURC_FILTER_SOLD4CROWN = "Boutique à Couronnes",
  SI_FURC_FILTER_SOLD4CROWN_TT = "Affiche les articles qui ne peuvent être achetés que dans la boutique à couronnes",
  SI_FURC_ITEMSRC_CROWNSTORE = "Boutique à Couronnes ",
  ...
  SI_FURC_FILTER_FAVE = "Favoris",
  SI_FURC_FILTER_FAVE_TT = "Affiche vos favoris",
  ...
  SI_FURC_FILTER_CRAFTING = "Fabriquable: Tous",
  SI_FURC_FILTER_CRAFTING_KNOWN = "Fabriquable: connu",
  SI_FURC_FILTER_CRAFTING_KNOWN_TT = "Affiche uniquement les objets fabriquable connus",
  SI_FURC_FILTER_CRAFTING_TT = "Affiche tous les objets à fabriquer",
  SI_FURC_FILTER_CRAFTING_UNKNOWN = "Fabriquable: inconnu",
  SI_FURC_FILTER_CRAFTING_UNKNOWN_TT = "Affiche uniquement les objets fabriquable inconnus",
  ...
  SI_FURC_FILTER_NONE = "Filtre source: désactivé",
  SI_FURC_FILTER_NONE_TT = "Désactive ce filtre",
  ...
  SI_FURC_FILTER_SOLD4AP = "Achetable (PA)",
  SI_FURC_FILTER_SOLD4AP_TT = "Objets vendus contre des points d'alliance",
  ...
  SI_FURC_FILTER_SOLD4WRIT = "Vendeur commandes de maîtres",
  SI_FURC_FILTER_SOLD4WRIT_TT = "Obtenable par les commandes de maîtres dans la capitale de votre alliance",
  ...
  SI_FURC_FILTER_SOLD4GOLD = "Achetable (OR)",
  SI_FURC_FILTER_SOLD4GOLD_TT = "Affiche uniquement les objets qui ne peuvent pas être fabriqués",
