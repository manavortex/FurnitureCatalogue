...
local strings = {
  ...
  SI_FURC_REQUIRES_QUEST =              ", Nécessite une quête ",
  ...
  SI_FURC_WW =                    "Parfois trouvé dans les nœuds du bois ",
  ...
  SI_FURC_DB_STEALTH =            "Comme moyen d'être moins intrusif ",
  SI_FURC_DAILY_ASH =             "Récompenses des quêtes quotidiennes d'Ashlander ",
  ...
  SI_FURC_DROP =                  "Cet article tombe à ", 
  SI_FURC_DROP_ALTMER =           "Cet article tombe à Summerset", 
  SI_FURC_FLAME_ATRONACH =        "Atronach de Flamme ",
  SI_FURC_DWEMER =                "Dwemer",
  SI_FURC_REAPER =                "Récolte du faucheur",
  SI_FURC_CHESTS =                "Des Cassetes",
  SI_FURC_ITEMSOURCE_SAFEBOX =    "Extrêmement rarement dans les Cassetes",
  SI_FURC_VVARDENFELL_PAINTING =  "Extrêmement rarement dans les Cassetes à Vvardenfell",
  SI_FURC_SUMMERSET_PAINTING =    "Extrêmement rarement dans les Cassetes à Summerset",
  ...
  SI_FURC_DATAMINED_UNCLEAR =     "Cet objet a été trouvé dans les sources / recettes de Summerset! \nSon origine n'est pas encore connue.",
