...
local strings = {
  ...
  SI_FURC_LOOT_CHESTS = "from treasure chests",
  SI_FURC_LOOT_PICKPOCKET = "can be pickpocketed",
  SI_FURC_LOOT_STEALING = "can be stolen",
  -- 445 ENTRIES THE SAME IN BOTH LANGUAGES
