...
local strings = {
  ...
  SI_FURC_FILTER_SRC_NONE_TT = "Disables this filter. Use this one if you don't want the active filter included when multi-selecting.",
  ...
  SI_FURC_STRING_MENU_SHOWICONONLEFT_TT = "Show Green Check/Red X icon on left of the inventory item (it will move to the right when off)",
