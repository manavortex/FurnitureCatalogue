...
local strings = {
  ...
  SI_FURC_GRAMMAR_ORDER_LOC = "<<1>> <<2>>", -- EN: "<preposition> <location>" like "on Betnikh"
  ...
  SI_FURC_STRING_DUNGEONS = "<<1[found in dungeons/found in <<2>>/From dungeons: <<2>>]>>", -- different text for 0/1/N dungeons
  ...
  SI_FURC_STRING_PIECES = "<<1[ / /($d pieces)]>>", -- different text for 0/1/N pieces
