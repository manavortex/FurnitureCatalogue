--[[
AUTO-GENERATED - regenerated by .scripts/luaDoc_generateStr.py and luaDoc_generateGui.py
...
FurCDevControl_Close = ButtonControl
FurCDevControl_Header = LabelControl
FurCDevControl_TabBar = Control
FurCDevControl_Content = Control
---------- LVL: 05 ----------
---------- LVL: 06 ----------
FurCDevControl_Content_Right = Control
FurCDevControl_Content_Left = Control
---------- LVL: 07 ----------
---------- LVL: 08 ----------
FurCDevControl_Content_Right_clear = ButtonControl
FurCDevControl_Content_Right_fromTrader = ButtonControl
...
FurCDevControl_Houses_SearchBg = BackdropControl
FurCDevControl_HousesPager = Control
FurCDevControl_HousesList = Control
---------- LVL: 11 ----------
---------- LVL: 12 ----------
