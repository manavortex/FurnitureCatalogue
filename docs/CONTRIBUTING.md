...
1. 📬 create a PR from **dev** to **master** - **2️⃣**
   - if you are not a maintainer, make the PR to **dev** instead ([see udpate flow](#recommended-update-flow)) - **1️⃣**
...
6. 🔎 **check** the release PR - **3️⃣**
   ...
   - ⚠️ leave this PR note empty/unchanged, as it will not be updated in the changelogs
   - ⏪ if you missed anything better to just close it, then go back to step 1 with a new PR
