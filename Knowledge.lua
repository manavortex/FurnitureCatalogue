-- Character knowledge: LCK, knowledge checks, crafter tooltip line
...
function FurC.IsAccountKnown(recipeKey, recipeArray)
  ...
  if lckAvailable() and recipeArray.blueprint then
    return isKnownByName(getItemLink(recipeArray.blueprint), nil) == true
  end
