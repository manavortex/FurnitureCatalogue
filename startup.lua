...
this.version = 4081001 -- will be AUTOREPLACED with AddonVersion
...
local function getChoicesSource()
  choicesSource[src.NONE] = GetString(SI_FURC_FILTER_NONE)
  choicesSource[src.FAVE] = GetString(SI_FURC_FILTER_FAVE)
  choicesSource[src.CRAFTING] = GetString(SI_FURC_FILTER_CRAFTING)
  choicesSource[src.CRAFTING_KNOWN] = GetString(SI_FURC_FILTER_CRAFTING_KNOWN)
  choicesSource[src.CRAFTING_UNKNOWN] = GetString(SI_FURC_FILTER_CRAFTING_UNKNOWN)
  choicesSource[src.VENDOR] = GetString(SI_FURC_FILTER_SOLD4GOLD)
  choicesSource[src.PVP] = GetString(SI_FURC_FILTER_SOLD4AP)
  choicesSource[src.WRIT_VENDOR] = GetString(SI_FURC_FILTER_SOLD4WRIT)
...
local function getTooltipsSource()
  tooltipsSource[src.NONE] = GetString(SI_FURC_FILTER_NONE_TT)
  tooltipsSource[src.FAVE] = GetString(SI_FURC_FILTER_FAVE_TT)
  tooltipsSource[src.CRAFTING] = GetString(SI_FURC_FILTER_CRAFTING_TT)
  tooltipsSource[src.CRAFTING_KNOWN] = GetString(SI_FURC_FILTER_CRAFTING_KNOWN_TT)
  tooltipsSource[src.CRAFTING_UNKNOWN] = GetString(SI_FURC_FILTER_CRAFTING_UNKNOWN_TT)
  tooltipsSource[src.VENDOR] = GetString(SI_FURC_FILTER_SOLD4GOLD_TT)
  tooltipsSource[src.PVP] = GetString(SI_FURC_FILTER_SOLD4AP_TT)
  tooltipsSource[src.CROWN] = GetString(SI_FURC_CROWN_TT)
  tooltipsSource[src.WRIT_VENDOR] = GetString(SI_FURC_FILTER_SOLD4WRIT_TT)
