...
FURC_BAZAAR 			= FURC_FESTIVAL_DROP +1  	  -- 20
FURC_TOMES				= FURC_BAZAAR +1			  -- 21
FURC_EMPTY_STRING		= ""
...
FURC_WEALD				= FURC_NECROM	  +1
FURC_WORMS				= FURC_WEALD	  +1
FURC_SHADOWS			= FURC_WORMS	  +1
FURC_WORMS2				= FURC_SHADOWS	  +1
FURC_ZERO				= FURC_WORMS2	  +1
FURC_ZERO2				= FURC_ZERO		  +1

FURC_LATEST				= FURC_ZERO
