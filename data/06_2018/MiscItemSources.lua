...
-- Reach
FurC.MiscItemSources[ver.DRAGONS] = { -- Reach
  [src.DROP] = {
...
FurC.MiscItemSources[ver.CLOCKWORK] = { -- Reach
  [src.DROP] = {
...
FurC.MiscItemSources[ver.REACH] = { -- Reach
  [src.JUSTICE] = {
...
FurC.MiscItemSources[ver.MORROWIND] = { -- Morrowind
  [src.DROP] = {
