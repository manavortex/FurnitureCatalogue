...
local itempacks = {
  ...
  ["cragkitchen"] = SI_FURC_ITEMPACK_CRAGKITCHEN,
  ["cragbed"] = SI_FURC_ITEMPACK_CRAGBED,
  ["cragparlour"] = SI_FURC_ITEMPACK_CRAGPARLOUR,
  ...
  ["noblebath"] = SI_FURC_ITEMPACK_NOBLEBATH,
  ["nobleparlour"] = SI_FURC_ITEMPACK_NOBLEPAR,
  ["sanguine"] = SI_FURC_ITEMPACK_SANGUINE,
  ["writhing"] = SI_FURC_ITEMPACK_WRITHING,
  ["toymaker"] = SI_FURC_ITEMPACK_TOYMAKER,
  ["theater"] = SI_FURC_ITEMPACK_THEATER,
  ["nereid"] = SI_FURC_ITEMPACK_NEREID,
  ["combat"] = SI_FURC_ITEMPACK_COMBAT,
  ["winter"] = SI_FURC_ITEMPACK_WINTER,
  ["moonpath"] = SI_FURC_ITEMPACK_MOONPATH,
  ["jester"] = SI_FURC_ITEMPACK_JESTER,
  ["druidic"] = SI_FURC_ITEMPACK_DRUIDIC,
  ["haunted"] = SI_FURC_ITEMPACK_HAUNTED,
  ["dwarven"] = SI_FURC_ITEMPACK_DWARVEN,
  ["necrom"] = SI_FURC_ITEMPACK_NECROM,
  ["trees"] = SI_FURC_ITEMPACK_TREES,
  ["pipes"] = SI_FURC_ITEMPACK_DWARVENPIPES,
  ["firstblade"] = SI_FURC_ITEMPACK_FIRSTBLADE,
  ["loom"] = SI_FURC_ITEMPACK_LOOM,
  ["jyggalag"] = SI_FURC_ITEMPACK_JYGGALAG,
  ["ebony"] = SI_FURC_ITEMPACK_EBONY,
  ["razor"] = SI_FURC_ITEMPACK_RAZOR,
  ["hollowjack"] = SI_FURC_ITEMPACK_HOLLOWJACK,
  ["stable"] = SI_FURC_ITEMPACK_STABLE,
  ["noblekit"] = SI_FURC_ITEMPACK_NOBLEKIT,
  ["darien"] = SI_FURC_ITEMPACK_DARIEN,
...
[src.CROWN] = {
  ...
  [224853] = strPack("darien"), -- A Hero Strides Forth Painting, Gold
  [224852] = strPack("darien"), -- An Evening with Darien Painting, Gold
  [224851] = strPack("darien"), -- Statue, Meridia's Champion
  [225088] = strPack("darien"), -- Cheers to the Hero Painting, Gold
},
...
[src.CROWN] = {
    [217691] = strPack("moonpath"), -- Moonlight Path Bridge, Long
    [217689] = strPack("moonpath"), -- Moonlight Path Platform, Whorls
	...
	[217694] = strPack("sanguine"), -- Carnaval Fountain, Wine
    [217695] = strPack("sanguine"), -- Carnaval Tent, Open
    [217696] = strPack("sanguine"), -- Carnaval Wall, Square Cloth
    [217697] = strPack("sanguine"), -- Carnaval Wall, Rectangular Cloth
...
[src.EDITOR] = {
	[211502] = strMultiple(strCrown(410), strPack("dwarven")), -- Dwarven Furnace
	[211501] = strMultiple(strCrown(270), strPack("dwarven")), -- Dwarven Dais, Stone
    [211500] = strMultiple(strCrown(1200), strPack("dwarven")), -- Dwarven Archway
	[203880] = strMultiple(strCrown(200), strPack("dwarven")), -- Dwarven Red Lamp, Cylinder Cage
},
...
[src.CROWN] = {
    ...
    [203601] = strPack("haunted"), -- Haunted Dresser, Floating
},
...
[src.CROWN] = {
	...
	[146047] = strMultiple(getHouseString(9735), strPack("newlife2018")), -- From Old Life To New
...
[src.EDITOR] = {
	...
	[183891] = strMultiple(strCrown(430), strPack("aquatic")), -- Jellyfish Bloom, Heliotrope
},
...
[src.EDITOR] = {
    ...
    [182230] = strMultiple(strCrown(140), strPack("fargrave"), getHouseString(13882)), -- Mushrooms, Glowing Shelf
},
...
[src.EDITOR] = {
	[181532] = strMultiple(strCrown(3600), getHouseString(9735), strPack("mermaid")), -- Leyawiin Fountain, Round Grand
    ...
    [181486] = strMultiple(strCrown(2700), strPack("mermaid"), getHouseString(9735)), -- Leyawiin Fountain, Round
    [181599] = strMultiple(strCrown(1100), strPack("mermaid"), getHouseString(9735)), -- Leyawiin Fountain, Tall
...
[src.EDITOR] = {
    ...
    [175696] = strMultiple(strCrown(410), strPack("zeni"), getHouseString(9735, 9412)), -- Leyawiin Tapestry, Divines Horizontal
    [175697] = strMultiple(strCrown(410), strPack("zeni"), getHouseString(9412)), -- Leyawiin Tapestry, Divines Vertical 
},
...
[src.EDITOR] = {
    [166044] = strMultiple(strCrown(90), strPack("stable")), -- Watering Trough, Full
...
[src.EDITOR] = {
    ...
    [153661] = strMultiple(strCrown(40), strPack("khajiit"), strPack("stable")), -- Straw Pile
    [153662] = strMultiple(strCrown(40), strPack("khajiit"), getHouseString(13882)), -- Tool, Plow
    [153663] = strMultiple(strCrown(40), strPack("khajiit")), -- Tool, Sickle
    [153664] = strMultiple(strCrown(40), strPack("khajiit"), strPack("stable")), -- Tool, Pitchfork
    [153665] = strMultiple(strCrown(40), strPack("khajiit")), -- Tool, Hoe
    [153666] = strMultiple(strCrown(40), strPack("khajiit"), getHouseString(6752)), -- Tool, Two-Person Crosscut Saw
},
...
[src.EDITOR] = {
    ...
    [151842] = strMultiple(strCrown(20), strPack("oasis"), getHouseString(12456)), -- Plant, Cask Palm
    ...
    [151845] = strMultiple(strCrown(95), strPack("oasis"), mischouse), -- Elsweyr Potted Cactus, Flowering
    [151846] = strMultiple(strCrown(35), strPack("oasis"), strPack("mermaid"), mischouse), -- Elsweyr Potted Plant, Cask Palm
    ...
    [151834] = strMultiple(strCrown(90), strPack("oasis"), getHouseString(6399)), -- Tree, Desert Acacia Shade
	[151830] = strMultiple(strCrown(190), strPack("moonbishop"), mischouse), -- Elsweyr Divider, Elegant Wooden
	...
	[151831] = strMultiple(strCrown(290), strPack("moonbishop"), getHouseString(10051)), -- Elsweyr Sugar Pipe, Ceremonial
...
[src.EDITOR] = {
	[147585] = strMultiple(strCrown(40), strPack("forge"), getHouseString(6139)), -- Dwarven Gear, Large Spokes
    ...
    [147579] = strMultiple(strCrown(240), strPack("forge"), getHouseString(6139)), -- Dwarven Gearwork, Perpetual
    [147580] = strMultiple(strCrown(310), strPack("forge"), getHouseString(6139)), -- Dwarven Lamps, Heavy
    [147581] = strMultiple(strCrown(350), strPack("forge"), getHouseString(6139)), -- Dwarven Table, Heavy Workbench
    [147582] = strMultiple(strCrown(50), strPack("forge")), -- Dwarven Part, Sentry Head
    [147583] = strMultiple(strCrown(220), strPack("forge"), getHouseString(6139)), -- Dwarven Valve, Sealed
...
[src.EDITOR] = {
	...
	[141976] = strMultiple(strCrown(60), strPack("hollowjack")), -- Pumpkin Patch, Display
...
[src.EDITOR] = {
    ...
    [145448] = strMultiple(strCrown(1000), strPack("swamp"), getHouseString(5757)), -- Murkmire Throne, Engraved
    ...
    [146062] = strMultiple(strCrown(270), strPack("newlife2018")), -- Winter Ouroboros Wreath
    [146061] = strMultiple(strCrown(270), strPack("newlife2018")), -- New Life Triptych Banner
    [146060] = strMultiple(strCrown(95), strPack("newlife2018")), -- New Life Ladle
    [146059] = strMultiple(strCrown(360), strPack("newlife2018")), -- New Life Snowmortal, Khajiit
    [146058] = strMultiple(strCrown(360), strPack("newlife2018")), -- New Life Snowmortal, Argonian
    [146057] = strMultiple(strCrown(360), strPack("newlife2018")), -- New Life Snowmortal, Human
    [146056] = strMultiple(strCrown(130), strPack("newlife2018")), -- New Life Cookies and Ale
    [146055] = strMultiple(strCrown(65), strPack("newlife2018"), strPack("winter")), -- New Life Garland Wreath
    [146054] = strMultiple(strCrown(60), strPack("newlife2018"), strPack("winter")), -- New Life Garland
    [146053] = strMultiple(strCrown(480), strPack("newlife2018")), -- Guar Ice Sculpture
    [146052] = strMultiple(strCrown(480), strPack("newlife2018")), -- Vvardvark Ice Sculpture
    [146051] = strMultiple(strCrown(480), strPack("newlife2018")), -- Mudcrab Ice Sculpture
    [146050] = strMultiple(strCrown(2700), strPack("newlife2018")), -- Winter Festival Hearthfire
    [146049] = strMultiple(strCrown(750), strPack("newlife2018")), -- Winter Festival Hearth
    [146048] = strMultiple(strCrown(1200), strPack("newlife2018")), -- New Life Festive Fir
    ...
    [145447] = strMultiple(strCrown(260), strPack("swamp"), getHouseString(5757)), -- Murkmire Dais, Engraved
    [145445] = strPack("deepmire"), -- The Sharper Tongue: A Jel Primer
    [145443] = strMultiple(strCrown(270), strPack("deepmire"), getHouseString(5757)), -- Murkmire Shrine, Sithis Looming
    ...
    [145438] = strMultiple(strCrown(140), strPack("deepmire")), -- Grav-Stake, Large Glyphed
    ...
    [145433] = strMultiple(strCrown(60), strPack("deepmire"), getHouseString(5757)), -- Plant, Rafflesia
    ...
    [145428] = strMultiple(strCrown(65), strPack("deepmire"), getHouseString(11172)), -- Murkmire Lantern Post, Covered
...
[src.EDITOR] = {
    ...
    [139368] = strMultiple(strCrown(100), strPack("noblebath"), strPack("jester"), getHouseString(13558)), -- Alinor Bathing Robes, Decorative
    [139366] = strMultiple(strCrown(2000), strPack("nobleparlour")), -- Alinor Fountain, Regal
...
[src.CROWN] = {
    ...
    [134871] = strMultiple(strPack("tyrants"), getHouseString(8652)), -- Ancient Nord Urn, Dragon Crest
    [134873] = strMultiple(strPack("tyrants"), getHouseString(8652)), -- Ancient Nord Bookcase, Wide
    [134874] = strPack("tyrants"), -- Ancient Nord Bookcase, Narrow
    ...
    [134877] = strMultiple(strPack("tyrants"), getHouseString(8652)), -- Ancient Nord Funerary Jar, Dragon Figure
    [134878] = strPack("tyrants"), -- Ancient Nord Funerary Jar, Dragon Crest
    [134872] = strMultiple(strPack("tyrants"), getHouseString(8652)), -- Ancient Nord Brazier, Dragon Crest
    [134863] = strMultiple(strPack("tyrants"), getHouseString(8652)), -- Ancient Nord Sconce, Dragon Crest
	...
	[140220] = strPack("mephala"), -- Rumors of the Spiral Skein
...
[src.EDITOR] = {
	...
	[134882] = strMultiple(strCrown(90), strPack("hubtreasure"), getHouseString(14586)), -- Gold Drakes, Pristine
	...
	[134971] = strMultiple(strCrown(400), strPack("heart"), getHouseString(4794)), -- Candles, Votive Group
    ...
    [134901] = strMultiple(strCrown(45), strPack("dibella"), getHouseString(13882)), -- Flower Spray, Starlight Daisies
    ...
    [134906] = strMultiple(strCrown(240), strPack("dibella"), getHouseString(13060)), -- Ritual Brazier, Gilded
    [134892] = strMultiple(strCrown(85), strPack("dibella")), -- Tree, Pale Gold
    [134893] = strMultiple(strCrown(85), strPack("dibella"), getHouseString(14587)), -- Tree, Argent Blue
    [134894] = strMultiple(strCrown(20), strPack("dibella")), -- Wildflowers, Yellow and Orange
    [134897] = strMultiple(strCrown(45), strPack("dibella"), getHouseString(13882)), -- Vine Curtain, Festive Flowers
	[134921] = strMultiple(strCrown(520), mischouse, strPack("fargrave")), -- Redguard Lamppost, Stone
	...
	[139389] = strMultiple(strCrown(200), strPack("mephala")), -- Crystal, Crimson Cluster
	...
	[139376] = strMultiple(strCrown(260), strPack("nobleparlour"), getHouseString(5169, 5168)), -- Alinor Banner, Hanging
    ...
    [139332] = strMultiple(strCrown(45), strPack("aquatic"), getHouseString(11172, 5169)), -- Coral Formation, Tree Shelf
	...
	[139161] = strMultiple(strCrown(1500), strPack("mephala"), getHouseString(6752)), -- Daedric Table, Grand Necropolis
    [139160] = strMultiple(strCrown(200), strPack("mephala")), -- Daedric Armchair, Severe
    [139159] = strMultiple(strCrown(920), strPack("mephala"), getHouseString(6752, 10052)), -- Daedric Chandelier, Gruesome
    [139158] = strMultiple(strCrown(150), strPack("mephala"), getHouseString(6752)), -- Daedric Candelabra, Tall
    [139156] = strMultiple(strCrown(360), strPack("mephala")), -- Cocoon, Skeleton
    [139155] = strMultiple(strCrown(80), strPack("mephala")), -- Cocoon, Food Storage
    [139154] = strMultiple(strCrown(40), strPack("mephala")), -- Cocoons, Dormant Cluster
    [139153] = strMultiple(strCrown(40), strPack("mephala")), -- Cocoon, Dormant
    [139152] = strMultiple(strCrown(360), strPack("mephala")), -- Cocoon, Enormous Empty
    [139151] = strMultiple(strCrown(140), strPack("mephala")), -- Mushrooms, Shadowpalm Cluster
    [139150] = strMultiple(strCrown(70), strPack("mephala")), -- Mushrooms, Midnight Cluster
    [139149] = strMultiple(strCrown(30), strPack("mephala")), -- Plant, Scarlet Fleshfrond
    [139148] = strMultiple(strCrown(70), strPack("mephala")), -- Mushroom, Nettlecap
    [139147] = strMultiple(strCrown(30), strPack("mephala")), -- Plants, Scarlet Sawleaf
    [139146] = strMultiple(strCrown(490), strPack("mephala")), -- Crystals, Midnight Bloom
    [139145] = strMultiple(strCrown(430), strPack("mephala")), -- Crystals, Midnight Tower
    [139144] = strMultiple(strCrown(400), strPack("mephala")), -- Crystals, Midnight Spire
    [139143] = strMultiple(strCrown(310), strPack("mephala")), -- Crystals, Midnight Cluster
    [139142] = strMultiple(strCrown(380), strPack("mephala")), -- Crystals, Crimson Spikes
    [139141] = strMultiple(strCrown(310), strPack("mephala")), -- Crystals, Crimson Bed
    [139140] = strMultiple(strCrown(340), strPack("mephala")), -- Crystals, Crimson Spray
},
...
[src.CROWN] = {
	...
	[134251] = strPack("coldharbour"), -- Coldharbour Bookcase, Filled
    [134252] = strPack("coldharbour"), -- Coldharbour Bookcase, Black Laboratory
    [134253] = strPack("coldharbour"), -- Coldharbour Bookcase, Filled Wide
    [134256] = strPack("coldharbour"), -- Coldharbour Bookcase, Filled Pillar
...
[src.EDITOR] = {
    ...
    [134268] = strMultiple(strCrown(570), strPack("malacath"), getHouseString(1445)), -- Orcish Brazier, Column
    [134269] = strMultiple(strCrown(220), strPack("malacath"), getHouseString(1445)), -- Orcish Dais, Raised
    [116518] = strMultiple(strCrown(270), strPack("malacath")), -- Orcish Drop Hammer, Repeating
    [134267] = strMultiple(strCrown(380), strPack("malacath"), getHouseString(1445, 10223)), -- Orcish Table, Grand Furs
    [134263] = strMultiple(strCrown(410), strPack("malacath"), getHouseString(1445)), -- Orcish Throne, Ancient
    [134264] = strMultiple(strCrown(190), strPack("coldharbour")), -- Daedric Brazier, Cold-Flame
    [134273] = strMultiple(strCrown(200), strPack("coldharbour"), getHouseString(13881)), -- Daedric Plinth, Sacrificial
    [134274] = strMultiple(strCrown(200), strPack("coldharbour"), getHouseString(13881)), -- Coldharbour Crate, Black Soul Gem
    [134275] = strMultiple(strCrown(200), strPack("coldharbour"), getHouseString(13881)), -- Coldharbour Bin, Black Soul Gem
	...
	[134326] = strMultiple(strCrown(260), strPack("sotha"), getHouseString(1446)), -- Clockwork Pump, Horizontal
    [134250] = strMultiple(strCrown(750), strPack("sotha"), getHouseString(1446)), -- Fabrication Sphere, Inactive
	[134247] = strMultiple(strCrown(190), strPack("sotha"), getHouseString(1446)), -- Soul Gem Module, Experimental
	[134266] = strMultiple(strCrown(35), strPack("coldharbour"), getHouseString(10052, 6752)), -- Daedric Books, Stacked
    [134265] = strMultiple(strCrown(80), strPack("coldharbour"), getHouseString(10052, 6752)), -- Daedric Books, Piled
    [134373] = strMultiple(strCrown(410), strPack("sotha")), -- Clockwork Wall Machinery, Rectangular
    ...
    [134393] = strMultiple(strCrown(270), strPack("sotha"), getHouseString(1446)), -- Clockwork Workbench, Spacious
    ...
    [134397] = strMultiple(strCrown(410), strPack("sotha")), -- Clockwork Wall Machinery, Ovoid
    ...
    [134570] = strMultiple(strCrown(110), strPack("newlife2018"), getHouseString(1445)), -- Snow Pile
...
[src.EDITOR] = {
	...
	[130211] = strMultiple(strCrown(50), strPack("ayleid")), -- Books, Ordered Row
    [130210] = strMultiple(strCrown(50), strPack("ayleid")), -- Books, Scattered Row
	[130226] = strMultiple(strCrown(85), strPack("coven"), getHouseString(5461, 8697)), -- Carcass, Hanging Deer
    ...
    [130224] = strMultiple(strCrown(180), strPack("coven"), getHouseString(1310, 1311)), -- Reachmen Rug, Smooth Skin
    [130225] = strMultiple(strCrown(340), strPack("coven"), getHouseString(10052, 6752)), -- Skulls, Heap
    ...
    [130078] = strMultiple(strCrown(380), strPack("molag"), getHouseString(13881)), -- Soul Gem, Single
    [130079] = strMultiple(strCrown(380), strPack("molag")), -- Soul Gems, Pile  
    [130094] = strMultiple(strCrown(140), strPack("molag"), getHouseString(10052)), -- Daedric Chains, Hanging
    ...
    [130070] = strMultiple(strCrown(2000), strPack("molag"), getHouseString(13881)), -- Daedric Spout, Arched	
    [130080] = strMultiple(strPack("molag"), getHouseString(13881)), -- Soul Gems, Scattered   
    ...
    [130204] = strMultiple(strCrown(410), strPack("ayleid"), getHouseString(13560)), -- Welkynd Stones, Glowing
    ...
    [130199] = strMultiple(strCrown(170), strPack("ayleid"), getHouseString(9014)), -- Ayleid Bookshelf, Short Bare
    [130197] = strMultiple(strCrown(170), strPack("ayleid"), getHouseString(9014)), -- Ayleid Bookcase, Tall Filled
...
[src.CROWN] = {
    ...
    [125567] = strMultiple(getHouseString(1244), strPack("stable")), -- Hlaalu Shed, Open
...
[src.EDITOR] = {
	[130213] = strMultiple(strCrown(430), strPack("ayleid"), getHouseString(13560)), -- Ayleid Cage, Hanging
	[125581] = strMultiple(strCrown(25), getHouseString(1245)), -- Mushroom, Buttercake
    [126128] = strMultiple(strPack("azura"), getHouseString(6752)), -- The Five Points of the Star
...
[src.CROWN] = {
	...
	[117906] = strPack("cragknicks"), -- Redguard Urn, Gilded 
},
...
[src.EDITOR] = {
	...
	[94100] = strMultiple(strCrown(50), strPack("cragparlour"), srcLvlup, mischouse), -- Imperial BookCase, Swirled
	[117901] = strMultiple(strCrown(140), strPack("hubtreasure"), getHouseString(7601, 10051)), -- Redguard Amphora, Gilded
    [117894] = strMultiple(strCrown(240), strPack("cragbed"), strPack("hubtreasure"), mischouse), -- Redguard Divider, Gilded
    [117904] = strMultiple(strCrown(190), strPack("cragbed"), strPack("hubtreasure")), -- Redguard Trunk, Garish
	[121053] = strMultiple(strCrown(170), strPack("cragknicks"), strPack("hubtreasure")), -- Jar, Gilded Canopic
    [121046] = strMultiple(strCrown(30),strPack("cragknicks"), mischouse), -- Cheeses of Tamriel
    [118490] = strMultiple(strCrown(55),strPack("cragknicks"), mischouse), -- Scroll, Rolled
	[94163] = strMultiple(strCrown(290), strPack("dibella"), mischouse), -- Imperial Bench, Scrollwork
    ...
    [118107] = strMultiple(strCrown(40), strPack("noblekit"), getHouseString(1081)), -- Pie, Display
    ...
    [121021] = strMultiple(strCrown(10), strPack("trees")), -- Plants, Dry Underbrush
    [121020] = strMultiple(strCrown(10), strPack("trees"), getHouseString(1097, 1310)), -- Plants, Sparse Underbrush
    [121018] = strMultiple(strCrown(10), strPack("trees")), -- Plant, Forest Sprig
    [121014] = strMultiple(strCrown(20), strPack("trees"), getHouseString(14586)), -- Topiary, Sparse
    [121012] = strMultiple(strCrown(10), strPack("trees")), -- Trees, Fragile Autumn Birch
    [121009] = strMultiple(strCrown(70), strPack("trees")), -- Tree, Young Healthy Birch
    ...
    [120765] = strMultiple(strCrown(15), strPack("jester"), mischouse), -- Breton Cup, Empty
    ...
    [121053] = strMultiple(strCrown(170), strPack("hubtreasure")), -- Jar, Gilded Canopic
    ...
    [121019] = strMultiple(strCrown(10), strPack("trees"), getHouseString(1310, 14586)),  -- Plants, Dense Underbrush
    [121017] = strMultiple(strCrown(10), strPack("trees")), -- Bush, Dense Forest
    [121002] = strMultiple(strCrown(45), strPack("trees")), -- Flowers, Violet Prairie
    [121001] = strMultiple(strCrown(45), strPack("trees")), -- Flowers, Golden Prairie
    ...
    [118278] = strMultiple(strCrown(140), strPack("cragparlour"), getHouseString(7600)),  -- Plaque, Bordered Deer Antlers
	...
	[117882] = strMultiple(strCrown(70), strPack("cragbed"), getHouseString(14078)), -- Redguard Pillow, Florid Sands
	...
	[117897] = strMultiple(strCrown(480), strPack("cragparlour"), mischouse), -- Redguard Mat, Sun
	[117893] = strMultiple(strCrown(190), strPack("cragbed"), getHouseString(4795)), -- Redguard Footlocker, Bolted
	[117896] = strMultiple(strCrown(290), strPack("cragknicks"), getHouseString(1095, 7601)), -- Redguard Wine Rack, Bolted
	[119970] = strMultiple(strCrown(1400), strPack("cragkitchen")), -- Redguard Round Table
	[117891] = strMultiple(strCrown(250), strPack("cragkitchen"), mischouse), -- Redguard Armchair, Lattice
	[117892] = strMultiple(strCrown(230), strPack("cragbed"), mischouse), -- Redguard Chair, Lattice
	...
	[121049] = strMultiple(strPack("cragknicks"), mischouse), -- Parcels, Wrapped
    [120417] = strMultiple(strPack("cragknicks"), mischouse), -- Redguard Barrel, Corded
